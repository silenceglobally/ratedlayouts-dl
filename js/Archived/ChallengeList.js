        ...
        <main v-else class="page-list">
            ...
            <div class="level-container">
                <div class="level" v-if="level && level.id!=0">
                    ...
                    <h3>Difficulty: {{["Beginner", "Easy", "Medium", "Hard", "Insane", "Mythical", "Extreme", "Supreme", "Ethereal", "Legendary", "Silent", "Impossible", "Unfathomable"][level.difficulty]}} challenge</h3>
